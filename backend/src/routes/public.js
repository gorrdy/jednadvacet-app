...
export function mountPublicRoutes(app) {
  ...
  // RSVP write/delete + attendee list live in routes/events.js.
  ...
  // The /api/chat/my-event-chats listing lives in routes/events.js.
  ...
  // DM request lifecycle (request / accept / reject / contacts list)
  // lives in routes/dm.js.
  ...
  // Tier-4 event proposal create + list live in routes/events.js.
